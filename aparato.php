            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div>
                        <a href="aparato.php?a=<?php echo $info["id"] ?>&apagar=1" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i class="fas fa-paper fa-sm text-white-50"></i> Suspender</a>
